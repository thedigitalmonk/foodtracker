    ...
    >
      <div className="flex items-center justify-between mb-2.5">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-widest text-[#B45309]">
            Use soon
          </span>
        </div>
      ...
      <div className="flex items-baseline gap-1.5 mb-3.5">
        <span className="text-[40px] font-semibold leading-none tracking-[-0.03em] text-[#18181B] dark:text-white">
          {total}
        </span>
      ...
      <div className="flex flex-col gap-1.5 mt-auto">
        {expiring.map((it) => (
          <div key={it.id} className="flex items-center justify-between gap-2">
            <span className="text-[13px] font-medium text-[#18181B] dark:text-white truncate">
              {it.name}
            </span>
            <span
              className={cn(
                "text-[11px] font-semibold whitespace-nowrap",
                it.status === "expired" ? "text-[#EF4444]" : "text-[#B45309]"
              )}
            >
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="text-[12px] text-[#737373] mt-1">across 3 zones</div>
      </div>
    </button>
  );
}
...
export function SuggestTile({ items, onOpen }: { items: Item[]; onOpen: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="text-[12px] text-[#737373] mt-auto pt-2.5">
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="text-[12px] text-[#737373]">Barcode</div>
      </div>
    </button>
  );
}
